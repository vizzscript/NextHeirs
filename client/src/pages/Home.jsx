    ...
    <div className="h-screen w-full">
      ...
      <div className="flex flex-col items-center justify-center h-full w-full space-x-2 bg-gradient-to-r from-black  to-gray-950">
        ...
        <div className="space-x-2 flex
                ...
                md:flex-row">
          <Link to="/registration" className="inline-block h-14 w-56 px-14 py-3  bg-green-700  text-white font-medium text-xl leading-tight uppercase rounded-full shadow-md hover:bg-transparent hover:text-green-600 hover:border border-green-600">Register</Link>
          <br />
