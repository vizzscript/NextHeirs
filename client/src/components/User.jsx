    ...
    <div>
      ...
      <div className="text-center bg-white text-gray-800 h-screen py-36 w-full">
        ...
        <div className="flex justify-center items-center space-x-2">
          <button type='button' className='inline-block px-6 py-2.5 bg-green-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-green-700 '>Add Wills</button>
          <button type='button' className='inline-block px-6 py-2.5 bg-green-600 border border-green-600  text-green-600 font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-green-700 bg-transparent hover:text-white'>Add Assets</button>
        </div>
